...
<section class="banner">
  <div class="intro">
    ...
    <p><dfn>Cascading Style Sheets</dfn> (CSS) is a simple mechanism for
      ...
      <a href="{{ "/learn/" | locale_url }}">Learn more about CSS</a> and how to use it for your website.</p>
    <p>The <a href="{{ "/about/" | locale_url }}">CSS Working Group</a> is responsible for
...
This is the {{ page.lang }} homepage. It is modeled on a <a href="http://csswg.inkedblade.net/staging/redesign/divya/">2011 design by Divya Manian</a>.
